<<<<<<< Updated upstream:app/src/main/java/com/example/ulpgcmuseum/Adapter/EightyAdapter.kt
...
class AgeAdapter(private val ageList: ArrayList<Item>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val item : Item = ageList[position]
        holder.Name.text = item.Name

        holder.initialize(ageList.get(position))
...
>>>>>>> Stashed changes:app/src/main/java/com/example/ulpgcmuseum/Adapter/AgeAdapter.kt
}